# Ingesting data into the data lake using Airbyte 

## Introduction 
In this tutorial you will set up an Airbyte instance and read in data from GitHub. 
Then, create a table and read the Parquet data in the Trino table.
...
`trino-getting-started/airbyte/` directory. Now run the following
command:
